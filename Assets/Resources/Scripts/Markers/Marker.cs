...
public class Marker : MonoBehaviour
{
    ...
    private void Create() 
    {
        ...
        marker = trackableBehaviour.gameObject;
    }
    ...
    public GameObject GetMarkerGameObject() {return marker;}
    public DataSetTrackableBehaviour GetMarkerTrackableBhv() { return trackableBehaviour; }
}
